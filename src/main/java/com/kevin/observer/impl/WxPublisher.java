package com.kevin.observer.impl;

import com.kevin.dto.IdentityInfo;
import com.kevin.enums.WxInformType;
import com.kevin.enums.WxTemplateType;
import com.kevin.observer.Publisher;
import com.kevin.observer.Subscriber;
    ...
    public void update(Subscriber subscriber) {
        for (Subscriber before : subscribers) {
            if (before.equals(subscriber)) {
                ...
                oldInfo.setPrecise(newInfo.getPrecise());
                ...
                oldInfo.setAdcode(newInfo.getAdcode());
                return;
            }
        }
    }
